...
// -----[ igp_domain_for_each ]--------------------------------------
extern int igp_domain_for_each(FIGPDomainsForEach fForEach, void * pContext);
...
// ----- register_igp_domain ----------------------------------------
extern int register_igp_domain(SIGPDomain * pDomain);
...
extern int igp_domain_contains_router_by_addr(SIGPDomain * pDomain,
					      net_addr_t tAddr);
// ----- igp_domain_dump --------------------------------------------
extern int igp_domain_dump(SLogStream * pStream, SIGPDomain * pDomain);
// ----- igp_domain_info --------------------------------------------
extern void igp_domain_info(SLogStream * pStream, SIGPDomain * pDomain);
// ----- igp_domain_compute -----------------------------------------
